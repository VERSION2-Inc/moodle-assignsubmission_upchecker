...
/**
 * The assignsubmission_upchecker assessable uploaded event.
 *
...
namespace assignsubmission_upchecker\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The assignsubmission_upchecker assessable uploaded event class.
 *
 * @package    assignsubmission_upchecker
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'assignsubmission_upchecker');
    }
