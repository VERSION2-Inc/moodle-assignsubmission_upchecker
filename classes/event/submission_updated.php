...
/**
 * The assignsubmission_upchecker submission_updated event.
 *
...
/**
 * The assignsubmission_upchecker submission_updated event class.
 *
...
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    protected function init() {
        parent::init();
        $this->data['objecttable'] = 'assignsubmission_upchecker';
    }
