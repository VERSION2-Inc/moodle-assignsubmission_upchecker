 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_upchecker_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_assignsubmission_upchecker_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignsubmission_upchecker', $data);

        $this->add_related_files('assignsubmission_upchecker',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
